...
<head>
        ...
        <link href="{{asset('contents/admin')}}/assests/css/vendor/jquery-jvectormap-1.2.2.css" rel="stylesheet" type="text/css" />
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg p-0">
                                    ...
                                    <div class="p-2">
                                        ...
                                        <div class="row g-0">
                                            ...
                                            <div class="col">
                                                <a class="dropdown-icon-item" href="#">
                                                    <img src="{{asset('contents/admin')}}/assets/images/brands/g-suite.png" alt="G Suite">
                                                    <span>G Suite</span>
                                                </a>
                                            </div>
                                        </div> <!-- end row-->
...
<!-- Mirrored from coderthemes.com/hyper/saas/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Oct 2021 15:15:26 GMT -->
</html>